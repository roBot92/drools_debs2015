...
public class Route implements Comparable<Route>{
	...
	private long lastDropoffTime;
	public Route(Cell pickup_Cell, Cell dropoff_Cell, long lastDropoffTime, long frequency) {
	...
	public String toString() {
		return "Route - Pickup cell:" + pickup_Cell + " Dropoff cell:" + dropoff_Cell + " - Frequency:" + frequency + " - Last Dropoff Time: "+(new Date(lastDropoffTime));
	}
